<div id="footer" class="clearfix">
	...
	<div class="mmda container_12">
		<div class="responsavel grid_6">
			<p>Responsável Técnico: Julio Roberto Diehl (CRM 3.983 RS).</p>
		</div>
		<div class="assinatura grid_6">
			<p><?php echo l('MMDA Digital','http://www.mmdadigital.com.br')?></p>
		</div>
	</div>
</div>
